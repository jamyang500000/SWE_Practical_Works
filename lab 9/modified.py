...
class Graph:
    ...
    def _dfs_recursive(self, vertex, visited):
        ...
        for neighbor, _ in self.graph[vertex]:  # Adjusted to unpack neighbor and weight
            if neighbor not in visited:
                self._dfs_recursive(neighbor, visited)

    def bfs_shortest_path(self, start_vertex, end_vertex):
        visited = {start_vertex}
        queue = deque([(start_vertex, [start_vertex])])  # Corrected line: Added closing parenthesis
        ...
        for vertex in self.graph:
            if vertex not in color:
                ...
                while queue:
                    ...
                    for neighbor, _ in self.graph[current]:  # Adjusted to unpack neighbor and weight
